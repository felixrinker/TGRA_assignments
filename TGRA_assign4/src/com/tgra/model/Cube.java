...
public class Cube {
    ...
    /**
     * Constructs an Cube without texture
     */
    public Cube() {
    	this("");
    }
    ...
    /**
     * Constructs an Cube with texture
     */
    ...
    public void loadTexture(String texturePath) {
    	 this.textureSet = !texturePath.isEmpty();
         if(this.textureSet) tex = new Texture(Gdx.files.internal(texturePath));
    }
